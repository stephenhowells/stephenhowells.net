...
TEMPLATE = "/Users/Stephen/Dev/stephenhowells.net/_automators/templates/link-template.md"

# Change this to where ever your _drafts folder is
POSTS_DIR = "/Users/Stephen/Dev/stephenhowells.net/_drafts"

# Get the title and use it to derive the new filename
title = "{query}"
filename = "#{title.parameterize}.markdown"
